...
if (isset($_POST['reg_submit'])) {
    ...
    $account = $mongo_db->execQuery('chk_created_producer', [$_POST['mail']]);
    ...
    if ($account) {
        ...
        if ($_POST['pwd'] == $_POST['pwd_chck']) {
            ...
            $mongo_db->execQuery('insert_new_producer', [$_POST['mail'], $_POST['pwd'], $_POST['name'], $target_name], $random_confirm_code);
