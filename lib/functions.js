...
function show_log_reg() {
    ...
    fetch("/DAW_proyecto_final/templates/components/login.php", { method: "GET" })
    .then(response => response.text())
    .then(text => {
...
function show_register() {
    fetch("/DAW_proyecto_final/templates/components/register.php", { method: "GET" })
    .then(response => response.text())
    .then(text => {
...
function load_conversation(elem) {
    fetch(`/DAW_proyecto_final/templates/components/dash/blocks/chat_box.php?conv=${elem}`, { method: "GET" })
    .then(response => response.text())
    .then(text => {
