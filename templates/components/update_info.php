...
// FIX Las provincias que tienen un espacio en su valor, solo se ve la primera palabra (antes de espacio)
$province_pool = [
...
<form id='update_login_form' action="/DAW_proyecto_final/modules/update_info_logic.php" method="post">
    <fieldset>
...
<form id='update_contact_form' action="/DAW_proyecto_final/modules/update_info_logic.php" method="post">
    <fieldset>
...
<form id='update_location_form' action="/DAW_proyecto_final/modules/update_info_logic.php" method="post">
