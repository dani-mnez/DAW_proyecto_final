...
<head>
    ...
    <!-- OJO No se si el js de estilos ponerlo en header o footer, o en ambos según necesidades, revisar -->
    <script type="text/javascript" src="/DAW_proyecto_final/lib/styles.js"></script>
