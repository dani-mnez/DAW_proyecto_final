    ...
    <div id="opinion_stats">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <div class="rate_bar">
                        <div class="rate_meter" style="<?php echo $bar_style[0] ?>" />
                    </div>
                </td>
            ...
            <tr>
                ...
                <td>
                    <div class="rate_bar">
                        <div class="rate_meter" style="<?php echo $bar_style[1] ?>" />
                    </div>
                </td>
            ...
            <tr>
                ...
                <td>
                    <div class="rate_bar">
                        <div class="rate_meter" style="<?php echo $bar_style[2] ?>" />
                    </div>
                </td>
            ...
            <tr>
                ...
                <td>
                    <div class="rate_bar">
                        <div class="rate_meter" style="<?php echo $bar_style[3] ?>" />
                    </div>
                </td>
            ...
            <tr>
                ...
                <td>
                    <div class="rate_bar">
                        <div class="rate_meter" style="<?php echo $bar_style[4] ?>" />
                    </div>
                </td>
